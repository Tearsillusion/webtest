    ...
    history:[
        ...
        },
        {
            list:[
                ...
                {
                    src:'img/yangyang.jpg',
                    time:'前端——小仙女本人',
                    motto:'座右铭：忘羡一曲远，曲终人不散，问灵十三载，等一不归人。',
                    content:'看昵称就知道，又是一个小美女入住本群，是个很爱学习的妹子呦，精通html5+css3布局，vue,mui学习者，想要QQ的赶紧加我，贿赂贿赂我或许会给你呦。'
                },
                {
                    src:'img/ersi.jpg',
                    time:'前端——24',
                ...
                },
                {
                    ...
                    time:'原生APP——盛夏',
                    motto:'座右铭：不详',
                    content:'群里唯一的APP大佬，四年APP经验，精通ios，安卓。'
                },
                {
                ...
                },
                {
                    ...
                    content:'别说话，我想静静，好吧，在静静的威逼下，介绍下他的个人技能；精通html5+css3布局,精通前端各种类库，框架的忠实爱好者。'
                },
                {
                    src:'img/shuishui.jpg',
                    time:'前端——水水(王水水)',
                    motto:'座右铭：不详',
                    content:'看照片就知道是哥哥的忠实粉丝，当然也是贱贱的GF，前端的小弟弟。'
                },
                {
                    src:'img/xinxin.jpg',
                    time:'前端——心心(小小心)',
                    motto:'座右铭：别说话，我还没想好',
                    content:'小心点，喊我的名字小心点，前端群里唯一的美女，额... ，唯一的单身美女，听说她过目不忘哟，精通html5+css3布局,熟悉各类ui框架。'
                },
				{
				    src:'img/meijun.jpg',
				    time:'前端——美美(未来可期❤❤)',
				    motto:'座右铭：何以解忧，唯有暴富，',
				    content:'集可爱于一身，拥有肥肉和头脑，熟悉HTML，css，js，vue，在前端的大道上越走越远。。。'
				}
